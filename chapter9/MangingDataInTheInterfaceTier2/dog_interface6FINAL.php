...
try {
	...
	if (isset($_POST['dog_app'])) {
		if ((isset($_POST['dog_name'])) && (isset($_POST['dog_breed'])) && (isset($_POST['dog_color'])) && (isset($_POST['dog_weight']))) {
			...
			//before wa used filte_var($_POST['dog_name], FILTER_SANITIZE_STRING) for all the properties
			...
			//code from dog_interface1.php to dog_interface3.php
  ...
  // select box
    ...
    $dog_app = $container->get_dog_application("breeds");
		...
		//code from dog_interface4.php to dog_interface5.php
		$container = NULL;
