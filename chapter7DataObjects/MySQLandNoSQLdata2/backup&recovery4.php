...
class dog_data {
  ...
  */
  ...
  function __destruct() {
    ...
    if (!rename("C://Program Files (x86)//EasyPHP-Devserver-17//eds-www//chapter7DataObjects//MySQLandNoSQLdata2//$this->dog_data_xml", "C://Program Files (x86)//EasyPHP-Devserver-17//eds-www//chapter7DataObjects//MySQLandNoSQLdata2//$oldxmldata")) {
...
/*       a:1:{i:0;a:4:{s:8:"dog_name";s:7:"Spot";s:10:"dog_weight";s:2:"19";s:9:
  ...
  function processRecords(string $change_type, $records_array,int $record_number) {
    switch ($change_type) {
      case "Delete":
      ...
      case "Update":
        ...
        break;
      case "Display":
        $this->readRecords($record_number);
        break;
      default:
...
$records_array = Array (
  ...
  1 => Array ( "dog_name" => "James", "dog_weight" => "21",
  "dog_color" => "Black", "dog_breed" => "Mixed" ));

$test = new dog_data();

$test->processRecords('Delete', array(), 2);
