...
//the html code is now wrapped within the else statement
{
echo "<p>Welcome back, " . $_SESSION['username'] . "</p>";
//php allows to open and close the php tag as many times as we need, so now we wrap the html code within the else statement
//the users can access to this part of the code only if they are logged in
?>
<!DOCTYPE html>
<html lan="en">
<head>
...
<?php
//here we open the php tag again and then we close the else bracket
}
?>